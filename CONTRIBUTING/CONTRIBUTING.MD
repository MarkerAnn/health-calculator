...
Our CI/CD process automatically generates a test report after running the test suite. This report is saved as [TESTREPORT.md](../TESTREPORT.md) in the repository root.
Important: Do NOT manually edit or commit changes to [TESTREPORT.md](../TESTREPORT.md). This file is automatically generated and any manual changes will be overwritten by the CI/CD process. Modifying this file can lead to inaccurate test reporting.
The [TESTREPORT.md](../TESTREPORT.md) includes:
